...
type LoadingPagetwoNavigationProp = StackNavigationProp<RootStackParamList, 'LoadingPagetwo'>;

type Props = {
  navigation: LoadingPagetwoNavigationProp;
};
...
const LoadingPagetwo: React.FC<Props> = ({ navigation }) => {
